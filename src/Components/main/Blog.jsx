  ...
  return (
    <div className='mx-5 '>
      ...
      <div className='grid grid-cols-3'>
        <div>
          <img src={image1} alt="" />
          <h1 className='text-xl mt-5 mb-5'>GovTrust: Latest News</h1>
          <p className='text-normal text-[#333333] mb-5'>Get real-time updates on our initiatives, including new partnerships, successful events, and milestones we’ve achieved. Stay connected with our ongoing efforts to bring education to every child.</p>
